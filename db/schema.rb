...
ActiveRecord::Schema.define(version: 2022_08_15_050034) do
  ...
  create_table "buyer_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["buy_id"], name: "index_buyer_addresses_on_buy_id"
  end
  ...
  create_table "buys", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["commodity_id"], name: "index_buys_on_commodity_id"
  ...
  add_foreign_key "buyer_addresses", "buys"
  add_foreign_key "buys", "commodities"
